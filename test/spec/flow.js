  ...
  describe('no delay', function() {
    ...
    it('play', function(done) {
      ...
      utils.intervalExec([
        ...
        100, function() {
          traceLog.length = 0;
          logTime = TimedTransition.roundTime(Date.now());
          utils.initLog();
    ...
    it('play -> play', function(done) {
      ...
      utils.intervalExec([
        ...
        // ====================================
        DURATION - LESS_PLAY + 100, function() {
          expect(traceLog).toEqual([
            '<on>', '_id:' + transition._id, 'state:STATE_STOPPED', 'force:false',
            'isOn:false', 'runTime:0', 'startTime:0', 'currentPosition:0',
  ...
  describe('delay: 3s', function() {
    ...
    it('delay -> play -> turn', function(done) {
      ...
      utils.intervalExec([
        ...
        // ====================================
        DELAY + LESS_PLAY, function() {
          utils.addLog('OFF', transition);
          transition.off();
        },
        // ====================================
        DELAY + LESS_PLAY + 100, function() {
          expect(traceLog).toEqual([
            '<on>', '_id:' + transition._id, 'state:STATE_STOPPED', 'force:false',
            'isOn:false', 'runTime:0', 'startTime:0', 'currentPosition:0',
    ...
    it('delay(before play) -> play', function(done) {
      ...
      utils.intervalExec([
        ...
        // ====================================
        DELAY + DURATION - LESS_DELAY + 100, function() {
          expect(traceLog).toEqual([
            '<on>', '_id:' + transition._id, 'state:STATE_STOPPED', 'force:false',
            'isOn:false', 'runTime:0', 'startTime:0', 'currentPosition:0',
  ...
  describe('delay: -3s', function() {
    ...
    it('nega-delay -> play -> turn', function(done) {
      ...
      utils.intervalExec([
        ...
        // ====================================
        NDELAY + LESS_PLAY /* <- turning position */ - NDELAY + 100, function() {
          expect(traceLog).toEqual([
            '<on>', '_id:' + transition._id, 'state:STATE_STOPPED', 'force:false',
            'isOn:false', 'runTime:0', 'startTime:0', 'currentPosition:0',
  ...
  describe('delay: -1s', function() {
    ...
    it('nega-delay -> play -> turn', function(done) {
      ...
      utils.intervalExec([
        ...
        // ====================================
        NDELAY + LESS_PLAY1 /* <- turning position */ - NDELAY + 100, function() {
          expect(traceLog).toEqual([
            '<on>', '_id:' + transition._id, 'state:STATE_STOPPED', 'force:false',
            'isOn:false', 'runTime:0', 'startTime:0', 'currentPosition:0',
    ...
    it('nega-delay -> play -> turn (2)', function(done) {
      ...
      utils.intervalExec([
        ...
        // ====================================
        NDELAY + LESS_PLAY2 /* <- turning position */ - NDELAY + 100, function() {
          expect(traceLog).toEqual([
            '<on>', '_id:' + transition._id, 'state:STATE_STOPPED', 'force:false',
            'isOn:false', 'runTime:0', 'startTime:0', 'currentPosition:0',
